...
public class Player extends Entity {
	...
	public void getPlayerImage() {
		...
		if (currentWeapon == null) {
			...
			up1 = setup("/player/pickaxe_up1", gp.tileSize * 5, gp.tileSize * 5);
			up2 = setup("/player/pickaxe_up2", gp.tileSize * 5, gp.tileSize * 5);
			down1 = setup("/player/pickaxe_down1", gp.tileSize * 5, 5 * gp.tileSize);
			down2 = setup("/player/pickaxe_down2", gp.tileSize * 5, 5 * gp.tileSize);
			left1 = setup("/player/pickaxe_left1", gp.tileSize * 5, gp.tileSize * 5);
			left2 = setup("/player/pickaxe_left2", gp.tileSize * 5, gp.tileSize * 5);
			right1 = setup("/player/pickaxe_right1", gp.tileSize * 5, gp.tileSize * 5);
			right2 = setup("/player/pickaxe_right2", gp.tileSize * 5, gp.tileSize * 5);
		}
	...
	public void getPlayerAttackImage() {
		...
		if (currentWeapon.type == type_pickaxe) {
			attackUp1 = setup("/player/pickaxe_up1", gp.tileSize * 5, gp.tileSize * 5);
			attackUp2 = setup("/player/pickaxe_attack_up", gp.tileSize * 5, gp.tileSize * 5);
			attackDown1 = setup("/player/pickaxe_down1", gp.tileSize * 5, gp.tileSize * 5);
			attackDown2 = setup("/player/pickaxe_attack_down", gp.tileSize * 5, gp.tileSize * 5);
			attackLeft1 = setup("/player/pickaxe_left1", gp.tileSize * 5, gp.tileSize * 5);
			attackLeft2 = setup("/player/pickaxe_attack_left", gp.tileSize * 5, gp.tileSize * 5);
			attackRight1 = setup("/player/pickaxe_right1", gp.tileSize * 5, gp.tileSize * 5);
			attackRight2 = setup("/player/pickaxe_attack_right", gp.tileSize * 5, gp.tileSize * 5);
		}
