...
public class UI {
	...
	public void drawTitleScreen() {
		...
		if (titleScreenState == 0) {
			...
			g2.drawString(text, x, y);
			if (commandNum == 0) {
				// g2.drawImage(gp.npc[0].down1, x- gp.tileSize, y-gp.tileSize, gp.tileSize ,
				// gp.tileSize , null);
	...
	public void drawCharacterScreen() {
		...
		g2.drawImage(c.down1, textX + gp.tileSize * 2 - 14, textY - gp.tileSize + 18, gp.tileSize * 3 / 4,
				gp.tileSize * 3 / 4, null);
		textY += lineHeight + 10;
