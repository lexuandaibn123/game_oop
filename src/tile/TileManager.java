...
public class TileManager {
	...
	public void getTileImage() {
		...
		setup(21, "bone_47", true);
		setup(22, "bone2_49", true);
		setup(23, "cactustree", true);
		setup(24, "dinosaur_48", false);
		setup(25, "fire_32", true);
		setup(26, "fire+soilleft_35", true);
		setup(27, "fire+soilleft_39", true);
		setup(28, "fire+soilright_38", true);
		setup(29, "firesoil_36", true);
		setup(30, "firesoillefttop_43", true);
		setup(31, "firesoilright_37", true);
		setup(32, "firesoilrighttop_44", true);
		setup(33, "firesoiltop_42", true);
		setup(34, "lavarock_51", true);
		setup(35, "magma_31", true);
		setup(36, "magmaSoil_33", true);
		setup(37, "rock_50", true);
		setup(38, "skull1_45", true);
		setup(39, "skull2_46", true);
		setup(40, "soil_30", false);
		setup(41, "soilmagma_34", true);
		setup(42, "treeonsoil_53", true);
		setup(43, "brigde", false);
		setup(44, "stairdown", false);
		setup(45, "stairup", false);
		setup(46, "earth01", false);
		setup(47, "000", true);
	}
